...
This demo is based on the Tuya Smart Cloud Platform, Tuya Smart APP, and IoTOS Embeded Ble SDK, and uses the Tuya BLE series module to quickly set up a knock sensor demo with the function of detecting knocking motion.
